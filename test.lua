...
getgenv().Config = {
	...
	["Webhook"] = {
		...
		["URL"] = "https://discord.com/api/webhooks/1126869149583425578/CPCwtmPK1nJGm5TH3SE8I2FkR1pmf8T1V28Mq8ju9Dv9zwWHAutXBLeqPwJgrPvbbaGz",
	...
	["Claimer"] = {
		...
		["Auto Claim Collection Milestone"] = false,
		["Auto Claim Achievement"] = false,
		["Auto Claim Daily Reward"] = false,
		["Auto Claim Collection"] = false,
		["Auto Claim Enemy Index"] = false,
		["Auto Claim Milestone"] = false
	},
	["Gameplay"] = {
		["Occult Hunt"] = {
	...
	["Summoner"] = {
		...
		["Auto Summon Winter"] = false,
		["Teleport Lobby new Banner"] = false,
		["Auto Summon Winter Memoria"] = false,
		["Delete Shiny Rarity"] = {
			["Legendary"] = false,
			["Mythic"] = false,
			["Exclusive"] = false,
	...
	["Auto Join Setting"] = {
		["Joiner Priority"] = {
			...
			["Raid Joiner"] = 3,
			["Winter Event Joiner"] = 9,
			["Stage Joiner"] = 1,
			["Odyssey Joiner"] = 7,
			["Weekly Challenge Joiner"] = 13,
			["Worldline Joiner"] = 6,
			["Limitless Odyssey Joiner"] = 8,
			["Regular Challenge Joiner"] = 11,
			["Boss Bounties Joiner"] = 10,
			["Dungeon Joiner"] = 4,
			["Daily Challenge Joiner"] = 12,
			["Rift Joiner"] = 14
		},
		["Joiner Cooldown"] = 0
	},
